...
st.markdown("There are only {0} variables because *corr()* can only gets correlation for numerical data.".format(df_corr.shape[1]))
...
st.markdown("Then, split data into train set and test set with the ratio 7：3 before training classification models.")
...
st.markdown("In the graph above, we conclude that the optimal number of clusters for the data is 5. Now, we can train the model on the data set with number of clusters 5.")
