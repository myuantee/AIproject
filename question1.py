...
spots = st.sidebar.slider("Number of Spots", min_value = 2, max_value = 10, value = 5, step = 1)
...
def objective(indiv):
    return (indiv[0]*(duration - 1)) + (indiv[1]*indiv[2]) + (indiv[3]*3*duration) + (indiv[4]*indiv[5]*duration)
...
def ga():
    ...
    total_exp = "Total vacation expenses: RM {}".format(int(total))
    st.info(total_exp)
...
st.write("""---""")
st.subheader("Comparison Before and After Modifying")

st.write("**Before Modifying:**")
fig, axs = plt.subplots(figsize = (10, 5))
axs.plot(hist1, label = "Method 1")
axs.plot(hist2, label = "Method 2")
axs.plot(hist3, label = "Method 3")
axs.set_xlabel("Generation")
axs.set_ylabel("Fitness")
axs.set_title("Fitness over Generation Before Modifying")
axs.legend()
st.pyplot(fig)

st.write("**After Modifying:**")
fig, axs = plt.subplots(figsize = (10, 5))
axs.plot(hist1_2, label = "Method 1")
axs.plot(hist2_2, label = "Method 2")
axs.plot(hist3_2, label = "Method 3")
axs.set_xlabel("Generation")
axs.set_ylabel("Fitness")
axs.set_title("Fitness over Generation After Modifying")
axs.legend()
st.pyplot(fig)
